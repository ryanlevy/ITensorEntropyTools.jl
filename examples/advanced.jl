...
mutual_info = get_mutual_info_region(p, [2, 3], [6, 7]; verbose=false)
@show mutual_info

# this is Renyi n=2 entropy instead of von Neumann
mutual_info = get_mutual_info_region(
...
trimutual_info = get_tripartite_ee_region(p, [2, 3], [4, 5], [6, 7]; verbose=true)
@show trimutual_info
