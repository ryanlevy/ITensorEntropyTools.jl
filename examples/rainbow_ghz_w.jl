...
@show round(
  tripartite_ee_region(
    psi, [L ÷ 2, L ÷ 2 + 1], [L ÷ 2 - 1, L ÷ 2 + 2], [L ÷ 2 - 2, L ÷ 2 + 3]
  ) / log(2),
  digits=2,
)
@show round(tripartite_ee_region(psi, [1, 2], [3, 4], [5, 6]) / log(2), digits=2)
...
@show round(
  tripartite_ee_region(
    ghz, [L ÷ 2, L ÷ 2 + 1], [L ÷ 2 - 1, L ÷ 2 + 2], [L ÷ 2 - 2, L ÷ 2 + 3]
  ) / log(2),
  digits=2,
)
@show round(tripartite_ee_region(ghz, [1, 2], [3, 4], [5, 6]) / log(2), digits=2)
...
@show round(tripartite_ee_region(Ws, [1, 2], [3, 4], [5, 6]) / log(2), digits=4)
